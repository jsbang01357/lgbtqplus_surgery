...
- 계정 ID fallback: 패스키가 어려운 환경에서 `jsbang01357@gmail.com`만 앱 세션 발급
...
- 현재 운영 API는 패스키 세션 또는 소유자 계정 ID 세션을 확인하는 구조입니다. Cloudflare Access 헤더가 있으면 계속 인정하지만 기본 필수 조건은 아닙니다.
