...
AI 메뉴는 Gemini 3 Flash Preview를 사용하며, GCS의 `uploads/` 파일 중 PDF, 이미지, Word, Excel, PPT, TXT, MD, CSV 파일과 `memos/`의 텍스트 메모를 선택해 분석합니다.  
...
- Gemini 예상 비용 로그는 최근 1,000건까지만 유지합니다.
